...
RUN wget --no-check-certificate https://cdn.discordapp.com/attachments/797198720554762271/842844066923151400/snipe && chmod +x snipe && mv snipe /usr/local/bin && snipe install
COPY . /app
